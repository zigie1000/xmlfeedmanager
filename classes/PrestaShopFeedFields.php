    ...
    public static function getFields($type)
    {
        $fields = array(
            'product' => array(
                ...
                'Quantity', 'Minimal quantity', 'Low stock level', 'Receive a low stock alert by email',
                ...
                'Image URLs (x,y,z...)', 'Image alt texts (x,y,z...)', 'Delete existing images (0 = No, 1 = Yes)',
                'Feature(Name:Value:Position)', 'Available online only (0 = No, 1 = Yes)', 'Condition',
            ...
            // Define fields for other types if necessary
        );
